...
qsub -Wblock=true -v HOME_FOLDER=$HOME_FOLDER,DATABASE_FOLDER=$DATABASE_FOLDER,INPUT_FOLDER=$INPUT_FOLDER,INPUT_FILE=$INPUT_NAME.json,OUTPUT_FOLDER=$OUTPUT_FOLDER build_alignment.sh
...
for gprotein in ${gprotein_list[@]}; do
    ...
    python3 /home/pmiglionico/FoldDock/src/pdockq.py \
...
qsub -Wblock=true -v OUTPUT_FOLDER=$OUTPUT_FOLDER,INPUT_NAME=$INPUT_NAME,HOME_FOLDER=$PWD model.sh